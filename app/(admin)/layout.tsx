...
import { LayoutDashboard, ClipboardCheck, BarChart3, Shield, Download, Users, LogOut } from 'lucide-react';

const ADMIN_NAV = [
  { href: '/admin/dashboard',   label: 'Dashboard',   icon: LayoutDashboard },
  { href: '/admin/matchs',      label: 'Validation',  icon: ClipboardCheck },
        ...
        <div className="px-5 py-5" style={{ borderBottom: '1px solid rgba(0,123,255,0.1)' }}>
          <Link href="/" className="flex items-center gap-2">
            ...
            <div>
              ...
              <div style={{ color: '#FFD700', fontSize: 10, fontWeight: 600 }}>ADMIN</div>
            </div>
          </Link>
        </div>
